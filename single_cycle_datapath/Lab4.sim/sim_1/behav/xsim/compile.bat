...
REM
REM Generated by Vivado on Thu Nov 17 08:47:27 +0300 2022
...
echo "xvlog --incr --relax -L uvm -prj mips_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj mips_tb_vlog.prj -log xvlog.log
