...
HD_PWD='C:/Users/pine1/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial_adder.tcl
