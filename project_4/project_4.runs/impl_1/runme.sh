...
HD_PWD='C:/Users/pine1/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serial_adder.tcl -notrace
