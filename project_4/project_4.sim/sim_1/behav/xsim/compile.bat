...
REM
REM Generated by Vivado on Thu Apr 14 16:37:07 +0300 2022
...
echo "xvlog --incr --relax -L uvm -prj serialadder_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj serialadder_tb_vlog.prj -log xvlog.log
