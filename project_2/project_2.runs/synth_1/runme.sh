...
HD_PWD='C:/Users/pine1/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serial.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serial.tcl
