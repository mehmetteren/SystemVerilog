...
HD_PWD='C:/Users/pine1/Desktop/CS224/Lab5/Lab5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mips.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_mips.tcl -notrace
