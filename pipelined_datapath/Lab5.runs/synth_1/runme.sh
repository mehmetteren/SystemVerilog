...
HD_PWD='C:/Users/pine1/Desktop/CS224/Lab5/Lab5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_mips.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_mips.tcl
