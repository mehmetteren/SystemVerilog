...
HD_PWD='C:/Users/pine1/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serial.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serial.tcl -notrace
