...
HD_PWD='C:/Users/pine1/CS223_Project/CS223_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log processor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source processor.tcl -notrace
